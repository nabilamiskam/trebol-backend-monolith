...
public class ConfirmOrderUseCase {
    ...
    public ConfirmOrderUseCase(OrderTransitionService transitionService) {
        this.transitionService = transitionService;
    }

    public Order confirm(OrderPojo sell) throws BadInputException, EntityNotFoundException {
        try {
            return transitionService.transition(sell, OrderTransitionCommand.CONFIRM);
